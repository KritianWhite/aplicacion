Public Class FormAdmin
    ...
    Private Sub Button6_Click(sender As Object, e As EventArgs) Handles BTN_agregarActivos.Click
        AgregarActivo.Show()
    End Sub
    Private Sub InformeDeAsignacionDeEquiposToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles InformeDeAsignacionDeEquiposToolStripMenuItem.Click
        InformeActivos.Show()
        InformeActivos.BackColor = ColorTranslator.FromHtml("#A7E0EA")
    End Sub
...
=======
    ...
    Private Sub PanelCliente_Paint(sender As Object, e As PaintEventArgs) Handles PanelCliente.Paint
        'PanelCliente.BackColor = ColorTranslator.FromHtml("#A7E0EA") ' Establecemos el color del panel.
    ...
    Private Sub PanelActivos_Paint(sender As Object, e As PaintEventArgs) Handles PanelActivos.Paint
        'PanelActivos.BackColor = ColorTranslator.FromHtml("#A7E0EA") ' Establecemos el color del panel.
    ...
    Private Sub PanelEquipos_Paint(sender As Object, e As PaintEventArgs) Handles PanelEquipos.Paint
        'PanelEquipos.BackColor = ColorTranslator.FromHtml("#A7E0EA") ' Establecemos el color del panel.
    ...
    Private Sub PanelSIM_Paint(sender As Object, e As PaintEventArgs) Handles PanelSIM.Paint
        'PanelSIM.BackColor = ColorTranslator.FromHtml("#A7E0EA") ' Establecemos el color del panel.
    ...
    Private Sub PanelUsuario_Paint(sender As Object, e As PaintEventArgs) Handles PanelUsuario.Paint
        'PanelUsuario.BackColor = ColorTranslator.FromHtml("#A7E0EA") ' Establecemos el color del panel.
    ...
    Private Sub TB_buscarClientes_TextChanged(sender As Object, e As EventArgs) Handles TB_buscarClientes.TextChanged
        ...
        For Each row As DataGridViewRow In DGV_clientes.Rows
            If row IsNot selectedRow Then
                ' Verificar que no sea la fila seleccionada, que no sea la fila de encabezado y que tenga al menos dos celdas
